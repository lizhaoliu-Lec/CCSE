...
"""
ReferenceSparseRCNN model and criterion classes.
"""
import torch
...
class SetCriterion(nn.Module):
    """ This class computes the loss for ReferenceSparseRCNN.
    ...
    def __init__(self, cfg, num_classes, matcher, weight_dict, eos_coef, losses, use_focal):
        ...
        if self.use_focal:
            self.focal_loss_alpha = cfg.MODEL.ReferenceSparseRCNN.ALPHA
            self.focal_loss_gamma = cfg.MODEL.ReferenceSparseRCNN.GAMMA
        else:
