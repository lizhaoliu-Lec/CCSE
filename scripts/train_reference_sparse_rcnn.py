...
from module.reference_sparse_rcnn.trainer import Trainer
from common.utils import plt_show, join

from initializer.instance_initializer import ReferenceInstanceInitializer


def main(init: ReferenceInstanceInitializer):
    config = init.config
...
if __name__ == '__main__':
    ...
    initializer = ReferenceInstanceInitializer(args.config)
